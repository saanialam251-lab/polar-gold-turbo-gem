...
import { a as House, i as Orbit, u as ChartColumn } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/shell-nrkNwCG5.js
...
function ch(order, id, name, topics) {
	return {
		id,
		name,
		order,
		topics: topics.map((name, i) => ({
			id: `topic-${String(i + 1).padStart(2, "0")}-${name.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/(^-|-$)/g, "")}`,
			name,
			order: i + 1
		}))
	};
...
var SYLLABUS = {
	...
	11: {
		...
		Mathematics: [
			...
			ch(5, "chapter-05-linear-inequalities", "Linear Inequalities", ["Inequalities in One Variable", "Graphical Solution in a Plane"]),
			...
			ch(13, "chapter-13-statistics", "Statistics", ["Mean Deviation", "Variance and Standard Deviation"]),
			ch(14, "chapter-14-probability", "Probability", [
				"Axiomatic Approach",
	...
	12: {
		Physics: [
			...
			ch(8, "chapter-08-electromagnetic-waves", "Electromagnetic Waves", ["Displacement Current", "EM Spectrum"]),
			...
			ch(11, "chapter-11-dual-nature-radiation-matter", "Dual Nature of Radiation and Matter", ["Photoelectric Effect", "de Broglie Hypothesis"]),
		...
		Chemistry: [
			...
			ch(9, "chapter-09-amines", "Amines", ["Basic Character of Amines", "Diazonium Salts"]),
		...
		Mathematics: [
			...
			ch(2, "chapter-02-inverse-trigonometric-functions", "Inverse Trigonometric Functions", ["Principal Value Branch", "Properties"]),
			...
			ch(8, "chapter-08-applications-integrals", "Applications of Integrals", ["Area under Simple Curves", "Area between Two Curves"]),
			...
			ch(12, "chapter-12-linear-programming", "Linear Programming", ["Formulation of LPP", "Graphical Method"]),
...
function getChapter(classId, subject, chapterId) {
	return SYLLABUS[classId][subject].find((c) => c.id === chapterId);
}
function Shell({ children, eyebrow, title, actions }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "orbit-grid min-h-dvh text-ink",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
			className: "sticky top-0 z-20 border-b border-line/80 bg-paper/90 backdrop-blur",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Orbit, { className: "size-4" })
			...
			children: [
				eyebrow ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mb-1 text-xs font-medium uppercase tracking-[0.18em] text-copper",
					children: eyebrow
				}) : null,
...
//#endregion
export { Shell as a, SYLLABUS as i, CLASS_META as n, getChapter as o, SUBJECTS as r, CLASSES as t };
