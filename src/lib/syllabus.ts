...
export const SYLLABUS: Record<ClassId, Record<Subject, Chapter[]>> = {
  9: {
    Physics: [
      ...
      ch(2, "chapter-02-force-and-laws-of-motion", "Forces and Laws of Motion", [
      ...
      ch(5, "chapter-05-gravitation", "Gravitation", [
        "Gravitation",
        "Free Fall",
        "Mass and Inertia",
        "Weight",
    ...
    Chemistry: [
      ...
      ch(3, "chapter-03-atoms-and-molecules", "Atoms and Molecules", [
      ...
      ch(4, "chapter-04-matter-and-its-surroundings", "matter and its surroundings", [
        "Physical Nature of Matter","Characteristics of Particles of Matter",
        "States of Matter",
        "Can Matter change its state ?","Evaporation",
        ]),
    ],
    Mathematics: [
      ...
      ch(9, "chapter-09-linear-equations-two-variables", "Linear Equations in Two Variables", [
      ...
      ch(10, "chapter-10-introduction-euclids-geometry", "Introduction to Euclid's Geometry", [
        "Point, Line and Plane",
        "Euclid's Definitions",
        "Euclid's Axioms and Common Notions",
        "Euclid's Five Postulates",
        "Equivalent Version of Fifth Postulate",
        "Theorems Based on Axioms",
        "Relationship Between Axiom, Postulate and Theorem",
        "Euclid's Geometry in Real Life",
      ]),
      ch(11, "chapter-11-herons-formula", "Heron's Formula", [
        "Area of Triangle - Base and Height",
        "Semi Perimeter",
        "Heron's Formula",
        "Area of Equilateral Triangle",
        "Area of Isosceles Triangle",
        "Area of Quadrilateral Using Heron",
        "Area of Triangle with Given Sides",
        "Applications of Heron's Formula",
      ]),
      ch(12, "chapter-12-statistics", "Statistics", [
        "Collection of Data",
  ...
  10: {
    Physics: [
      ch(1, "chapter-01-light-reflection-refraction", "Light: Reflection and Refraction", [
        ...
        "Advanced Ray Diagrams and Image Logic",
        "Reverse Image Formation",
        "Experimental and Graphical Optics",
      ]),
      ...
      ch(3, "chapter-03-electricity", "Electricity", [
        ...
        "Advanced Network Reasoning",
        "Experimental and Graphical Electricity",
        "Integrated Electricity Challenges",
      ]),
      ch(4, "chapter-04-magnetic-effects-current", "Magnetic Effects of Electric Current", [
        ...
        "Electric Generator",
        "Advanced Field Superposition",
        "Experimental and Graphical Magnetism",
        "Integrated Electromagnetic Reasoning",
      ]),
    ],
    Chemistry: [
      ch(1, "chapter-01-chemical-reactions-equations", "Chemical Reactions and Equations", [
        ...
        "Reaction Observation and Reasoning",
        "Stoichiometric Reaction Logic",
        "Reaction Chain Prediction",
      ]),
      ch(2, "chapter-02-acids-bases-salts", "Acids, Bases and Salts", [
        ...
        "Plaster of Paris",
        "Mixed Indicator and pH Logic",
        "Salt Preparation and Transformation",
      ]),
      ch(3, "chapter-03-metals-nonmetals", "Metals and Non-metals", [
        ...
        "Ionic Compounds",
        "Alloys and Property Reasoning",
        "Amphoteric Behaviour and Process Selection",
      ]),
      ch(4, "chapter-04-carbon-compounds", "Carbon and its Compounds", [
        ...
        "Reaction Pathways and Reagent Selection",
        "Structural and Functional-Group Reasoning",
      ]),
      ch(5, "chapter-05-periodic-classification-elements", "Periodic Classification of Elements", [
        "Why Classification Was Needed",
        "Dobereiner's Triads",
        "Newlands' Law of Octaves",
        "Mendeleev's Periodic Table",
        "Modern Periodic Law and Modern Periodic Table",
        "Trends and Periodicity in Modern Table",
        "Merits and Position of Elements in Modern Table",
      ]),
    ],
    Mathematics: [
  ...
  12: {
    ...
    Chemistry: [
      ...
      ch(4, "chapter-04-d-f-block-elements", "d- and f-Block Elements", [
        ...
        "Magnetic and Spectral Reasoning",
      ...
      ch(5, "chapter-05-coordination-compounds", "Coordination Compounds", [
        ...
        "VBT and CFT",
        "Advanced Coordination Reasoning",
        "Ligand-Field and Isomer Deduction",
      ]),
      ch(6, "chapter-06-haloalkanes-haloarenes", "Haloalkanes and Haloarenes", [
        ...
        "Stereochemical and Aromatic-Halide Reasoning",
      ]),
