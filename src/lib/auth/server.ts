...
export const auth = betterAuth({
  ...
  // Password length is 6-8 characters (matches src/lib/recovery/rules.ts). Better
  // Auth's own default minimum is 8, which silently rejected 6-7 character passwords.
